...
describe('IFCParagraph', () => {
  it('passes content through the slot', async () => {
    const wrapper = mount(IFCParagraph, {
      slots: {
  ...
  it('has baseClass that matches the base SCSS class', async () => {
    ...
    expect(wrapper.vm.baseClass).toBe('IFCParagraph');
  });
