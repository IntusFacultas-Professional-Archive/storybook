...
export default {
  title: 'Presentational Components/Typography/Paragraph',
  component: IFCParagraph,
  parameters: {
    jest: ['IFCParagraph.spec.js'],
  },
  argTypes: {
  },
};
...
const Template = (args, { argTypes }) => ({
  ...
  components: { IFCParagraph, IFCThemeProvider },
  template: `
    <IFCThemeProvider :dark="dark">
      <IFCParagraph v-bind="$props" >
        ${args.content ?? '<!-- Content Here -->'}
      </IFCParagraph>
    </IFCThemeProvider>
  `,
