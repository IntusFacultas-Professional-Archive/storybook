...
2. Include this script in the `<head>` of your template HTML file which can be found in `.nuxt/views/app.template.html`.

For JWICS and SIPR you'll need to download the file and include it locally. This polyfills CSS vars for IE11.
...
At the end of your project, you can consider what components you have implemented that potentially have reuseability for other projects, and extrac the stories and source code for those components and insert them into this Storybook, which is the canonical central storybook for NASIC UI components.
